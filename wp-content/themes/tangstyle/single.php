<?php get_header(); ?>
	<div id="main">
		...
		<div id="article">
            ...
            <div class="text_add">
                <div class="copy"><p style="color:#F00;">本文出自 <?php bloginfo('name');?> 的博客，转载时请注明出处及相应链接。</p><p style="color:#777;font-size:12px;">本文永久链接: <?php the_permalink() ?></p></div>
                <div class="share"><?php if (get_option('tang_share')!="") { echo stripslashes(get_option('tang_share')); } ?></div>
                </div>
